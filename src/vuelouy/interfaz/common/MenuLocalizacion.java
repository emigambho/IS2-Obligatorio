...
public class MenuLocalizacion extends javax.swing.JPanel implements Observer, ActionListener {
    ...
    private void initComponents() {
        ...
        lblRestante.setText(bundle.getString("MenuLocalizacion.lblRestante.text")); // NOI18N

        lblTiempoRestante.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        lblTiempoRestante.setText(bundle.getString("MenuLocalizacion.lblTiempoRestante.text")); // NOI18N

        lblHacia.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        lblHacia.setText(bundle.getString("MenuLocalizacion.lblHacia.text")); // NOI18N

        lblDesde.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        lblDesde.setText(bundle.getString("MenuLocalizacion.lblDesde.text")); // NOI18N

        lblOrigen.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        lblOrigen.setText(bundle.getString("MenuLocalizacion.lblOrigen.text")); // NOI18N

        lblDestino.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        lblDestino.setText(bundle.getString("MenuLocalizacion.lblDestino.text")); // NOI18N

        lblLocalizacion.setFont(new java.awt.Font("Tahoma", 0, 20)); // NOI18N
        lblLocalizacion.setText(bundle.getString("MenuLocalizacion.lblLocalizacion.text")); // NOI18N
    ...
    public void update(Observable o, Object o1) {
        ...
        lblDesde.setText(comunicacion.obtenerValorTraducido("MenuLocalizacion.lblDesde.text"));
        lblHacia.setText(comunicacion.obtenerValorTraducido("MenuLocalizacion.lblHacia.text"));
        lblRestante.setText(comunicacion.obtenerValorTraducido("MenuLocalizacion.lblRestante.text"));
        lblLocalizacion.setText(comunicacion.obtenerValorTraducido("MenuLocalizacion.lblLocalizacion.text"));
